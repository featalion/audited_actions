...
Configure AuditedActions, place the code bellow into config/initializers/audition_actions.rb
  ...
  module AuditedActions
    class Engine < Rails::Engine
      ...
      config.mongo = Rails.application.config.mongo
    end
  end

Mount engine to your application, add to config/routes.rb
